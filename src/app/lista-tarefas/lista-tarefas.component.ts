...
import {checkButtonTrigger, highlightedStateTrigger, shownStateTrigger,filterTrigger, formButtonTrigger, shakeTrigger } from '../animations';

@Component({
  selector: 'app-lista-tarefas',
  templateUrl: './lista-tarefas.component.html',
  styleUrls: ['./lista-tarefas.component.css'],
  animations: [highlightedStateTrigger, shownStateTrigger, checkButtonTrigger, filterTrigger, formButtonTrigger, shakeTrigger]
})
